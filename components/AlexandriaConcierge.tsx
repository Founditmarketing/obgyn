...
export function AlexandriaConcierge() {
  ...
  return (
    <section id="concierge" className="py-24 lg:py-32 bg-[#1A1F1B] text-[#F4F2EC] relative z-0">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row gap-12 xl:gap-32 max-w-[90rem] mx-auto items-center">
          ...
          <div className="lg:w-5/12 space-y-8 lg:space-y-12">
            ...
            <div className="pt-4">
              <Link href="/local-resources" prefetch={true} className="inline-block bg-[#F4F2EC] text-[#1A1F1B] px-10 py-6 rounded-full text-[10px] md:text-xs uppercase tracking-[0.25em] font-medium hover:bg-[#B89C86] hover:text-[#F4F2EC] transition-all duration-700 shadow-xl hover:-translate-y-1 transform">
