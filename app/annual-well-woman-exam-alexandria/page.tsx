...
export default function WellWomanExamPage() {
  ...
  const breadcrumbLd = breadcrumbSchema([
    { name: 'Home', path: '/' },
    { name: 'Annual Well-Woman Exams', path: PATH },
  ]);
  ...
  return (
    <div className="flex flex-col w-full bg-[#F4F2EC] min-h-screen">
      ...
      <section className="pt-32 pb-16 px-6 lg:px-12 max-w-5xl mx-auto text-center">
        <span className="text-xs uppercase tracking-[0.3em] font-medium text-[#8A928B] mb-6 block">Preventative Care</span>
        <h1 className="font-serif text-5xl md:text-7xl font-medium text-[#1A1F1B] mb-8 leading-[1.05] tracking-tighter text-balance">
          Annual Well-Woman <br className="hidden md:block"/><span className="italic font-light text-[#4A5D4E]">Preventative Exams</span>
        </h1>
      </section>
      ...
      <section className="py-4 px-6 lg:px-12 max-w-3xl mx-auto">
        <div className="space-y-6 text-xl text-[#1A1F1B]/80 font-light leading-relaxed text-balance">
          <p>
            Preventative care is the foundation of long-term wellness. Your annual well-woman exam includes a comprehensive pelvic exam, Pap smear, breast exam, and an opportunity to discuss any concerns—from cycle changes to family planning.
          </p>
          <p>
            We don't rush these appointments; they are your dedicated time to ensure your body is healthy and to catch any potential issues before they become serious.
          </p>
        </div>
        
        <div className="mt-20 text-center border-t border-[#1A1F1B]/10 pt-16 mb-20">
          <h3 className="font-serif text-3xl mb-8 text-[#1A1F1B]">Prioritize your health today.</h3>
